...
function semantic_entries( $classes = array() ) {
	...
	$classes = array( 'hentry', "p$semantic_post_alt", $post->post_type, $post->post_status );
	...
	if ( get_the_tags() == null ) $classes[] = 'untagged';
	else foreach ( get_the_tags() as $tag ) $classes[] = 'tag-' . $tag->slug;
