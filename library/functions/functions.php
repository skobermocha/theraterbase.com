...
function framework_media() {
	...
	wp_enqueue_script( 'jcarousellite', JS . '/jcarousellite_1.0.1.min.js', array( 'jquery' ) );
	wp_enqueue_script( 'cufon', JS . '/cufon-yui.js', array( 'jquery' ) );
	wp_enqueue_script( 'delicious', JS . '/Delicious.font.js', array( 'jquery' ) );
}
